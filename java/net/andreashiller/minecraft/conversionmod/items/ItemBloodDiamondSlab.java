...
public class ItemBloodDiamondSlab extends ItemBlock
{
    ...
    public ItemBloodDiamondSlab(Block block)
    {
        super(block);
        this.field_150949_c = (BlockSlab) BlockHandler.blockBloodDiamondHalfSlab;
        this.field_150947_d = (BlockSlab) BlockHandler.blockBloodDiamondDoubleSlab;
